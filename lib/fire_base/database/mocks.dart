...
Future<void> inserirDadosMock(AppDatabase db) async {
  await db.transaction(() async {
    ...
    final cargo = await db
        .into(db.cargo)
        .insert(CargoCompanion.insert(nome: 'Técnico', salario: 3500.00));
    ...
    final ordem1 = await db
        .into(db.ordemServicos)
        .insert(
